...
class VectorTileTestCase(TestCase):
    ...
    def test_postgis_layer(self):
        ...
        self.assertEqual(response.content,
                         b'\x1a8\n\x04features\x12\r\x12\x02\x00\x00\x18\x01"\x05\t\x80 \x80 \x12\r\x12\x02\x00\x00\x18\x01"\x05\t\x80 \x80 \x1a\x04name"\x07\n\x05feat1(\x80 x\x01',
                         response.content)
    ...
    def test_postgis_features(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.content, b'\x1a8\n\x04features\x12\r\x12\x02\x00\x00\x18\x01"\x05\t\x80 \x80 \x12\r\x12\x02\x00\x00\x18\x01"\x05\t\x80 \x80 \x1a\x04name"\x07\n\x05feat1(\x80 x\x01',
                         response.content)
